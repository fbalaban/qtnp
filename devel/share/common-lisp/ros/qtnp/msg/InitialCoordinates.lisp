...
(cl:defmethod cl:initialize-instance :after ((m <InitialCoordinates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InitialCoordinates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qtnp-msg:<InitialCoordinates> is deprecated: use qtnp-msg:InitialCoordinates instead.")))

(cl:ensure-generic-function 'uav_id-val :lambda-list '(m))
(cl:defmethod uav_id-val ((m <InitialCoordinates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qtnp-msg:uav_id-val is deprecated.  Use qtnp-msg:uav_id instead.")
  (uav_id m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <InitialCoordinates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qtnp-msg:longitude-val is deprecated.  Use qtnp-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <InitialCoordinates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qtnp-msg:latitude-val is deprecated.  Use qtnp-msg:latitude instead.")
  (latitude m))
