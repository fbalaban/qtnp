...
(cl:defmethod cl:initialize-instance :after ((m <Coordinates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Coordinates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qtnp-msg:<Coordinates> is deprecated: use qtnp-msg:Coordinates instead.")))

(cl:ensure-generic-function 'placemark_type-val :lambda-list '(m))
(cl:defmethod placemark_type-val ((m <Coordinates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qtnp-msg:placemark_type-val is deprecated.  Use qtnp-msg:placemark_type instead.")
  (placemark_type m))
