...
(cl:defclass <Coordinates> (roslisp-msg-protocol:ros-message)
  ((placemark_type
    ...
    :initform "")
   (seed_longitude
    :reader seed_longitude
    :initarg :seed_longitude
    :type cl:float
    :initform 0.0)
   (seed_latitude
    :reader seed_latitude
    :initarg :seed_latitude
    :type cl:float
    :initform 0.0)
   (longitude
    :reader longitude
...
(cl:ensure-generic-function 'seed_longitude-val :lambda-list '(m))
(cl:defmethod seed_longitude-val ((m <Coordinates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qtnp-msg:seed_longitude-val is deprecated.  Use qtnp-msg:seed_longitude instead.")
  (seed_longitude m))

(cl:ensure-generic-function 'seed_latitude-val :lambda-list '(m))
(cl:defmethod seed_latitude-val ((m <Coordinates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qtnp-msg:seed_latitude-val is deprecated.  Use qtnp-msg:seed_latitude instead.")
  (seed_latitude m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Coordinates>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'seed_longitude))))
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'seed_latitude))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Coordinates>) istream)
  "Deserializes a message object of type '<Coordinates>"
    ...
    (cl:setf (cl:slot-value msg 'seed_longitude) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'seed_latitude) (roslisp-utils:decode-double-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Coordinates>)))
  ...
  "0c53d7b4e0233648a057076b6c290607")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Coordinates)))
  "Returns md5sum for a message object of type 'Coordinates"
  "0c53d7b4e0233648a057076b6c290607")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Coordinates>)))
  ...
  (cl:format cl:nil "string placemark_type~%float64 seed_longitude~%float64 seed_latitude~%float64[] longitude~%float64[] latitude~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Coordinates)))
  "Returns full string definition for message of type 'Coordinates"
  (cl:format cl:nil "string placemark_type~%float64 seed_longitude~%float64 seed_latitude~%float64[] longitude~%float64[] latitude~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Coordinates>))
  ...
  (cl:list 'Coordinates
    ...
    (cl:cons ':seed_longitude (seed_longitude msg))
    (cl:cons ':seed_latitude (seed_latitude msg))
