...
static const char qt_meta_stringdata_qtnp__QNode[] = {
    "qtnp::QNode\0\0loggingUpdated()\0"
    "rosShutdown()\0"
};
...
const QMetaObjectExtraData qtnp::QNode::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject qtnp::QNode::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_qtnp__QNode,
      qt_meta_data_qtnp__QNode, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qtnp::QNode::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qtnp__QNode))
