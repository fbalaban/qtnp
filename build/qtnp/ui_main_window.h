...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        sizePolicy14.setHeightForWidth(line_edit_task_lon->sizePolicy().hasHeightForWidth());
        line_edit_task_lon->setSizePolicy(sizePolicy14);
        button_go_to_goal = new QPushButton(groupBox_5);
        button_go_to_goal->setObjectName(QString::fromUtf8("button_go_to_goal"));
        button_go_to_goal->setGeometry(QRect(320, 110, 80, 24));
        ...
        sizePolicy11.setHeightForWidth(line_edit_task_lat->sizePolicy().hasHeightForWidth());
        line_edit_task_lat->setSizePolicy(sizePolicy11);
